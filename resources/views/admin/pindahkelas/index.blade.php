            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" class="btn btn-primary w-100" onclick="document.getElementById('transferForm').submit()">Konfirmasi Pindah Kelas</button>
                    </div>
                </div>
            </div>
        </div>
...
<style>
    ...
    .input-group, .table, .form-group, .list-group-item {
        margin-bottom: 1rem;
    }
